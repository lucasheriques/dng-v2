...
export default async function LastArticleBanner() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-r from-teal-300 via-teal-700 to-teal-800 opacity-0 group-hover:opacity-100 transition-all duration-300 ease-in-out transform group-hover:scale-105" />
      <Balancer>
