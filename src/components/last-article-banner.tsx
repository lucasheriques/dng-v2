...
export default async function LastArticleBanner() {
  ...
  return (
    <Link
      ...
      className="px-4 z-20 flex w-full bg-linear-to-r from-slate-700 via-slate-600 to-slate-700 text-white text-center py-2 items-center justify-center relative group overflow-hidden"
    >
